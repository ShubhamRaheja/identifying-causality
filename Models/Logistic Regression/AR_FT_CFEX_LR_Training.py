...
Code Description: A python code to tune the hyperparameters of LR on the AR+FT+CFEX dataset.
"""
import os
import numpy as np
import pickle
...
EPSILON = [0.161] #np.arange(0.1, 0.49, 0.1) 0.161 0.01 0.01
...
RESULT_PATH = PATH + f'/LR-TUNING/AR_FT_CFEX_Hyperparameters/Length_{length}'
RESULT_PATH_FINAL = PATH + f'/TESTING-RESULTS/On_Training_set/AR_FT_CFEX_Results/Length_{length}'
RESULT_PATH_LR = PATH + '/LR-logs/AR_FT_CFEX_Checkpoints/'
