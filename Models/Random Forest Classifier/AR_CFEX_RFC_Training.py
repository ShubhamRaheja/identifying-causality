...
Code Description: A python code to tune the hyperparameters of RFC on the AR+CFEX dataset.
"""
import os
import numpy as np
import pickle
...
RESULT_PATH = PATH + f'/RFC-TUNING/AR_CFEX_Hyperparameters/Length_{length}'
RESULT_PATH_FINAL = PATH + f'/TESTING-RESULTS/On_Training_set/AR_CFEX_Results/Length_{length}'
RESULT_PATH_RFC = PATH + '/RFC-logs/AR_CFEX_Checkpoints/'
