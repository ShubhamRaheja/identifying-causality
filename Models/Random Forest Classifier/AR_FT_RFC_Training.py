...
Code Description: A python code to tune the hyperparameters of RFC on the AR+FT dataset.
"""
import os
import numpy as np
import pickle
...
RESULT_PATH = PATH + f'/RFC-TUNING/AR_FT_Hyperparameters/Length_{length}'
RESULT_PATH_FINAL = PATH + f'/TESTING-RESULTS/On_Training_set/AR_FT_Results/Length_{length}'
RESULT_PATH_RFC = PATH + '/RFC-logs/AR_FT_Checkpoints/'
