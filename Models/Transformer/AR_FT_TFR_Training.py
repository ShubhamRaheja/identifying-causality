...
Code Description: A python code to tune the hyperparameters of TFR on the AR+FT dataset.
"""
import os
import numpy as np
...
RESULT_PATH_TFR = PATH + '/TFR-logs/AR_FT_Checkpoints/'
...
RESULT_PATH = PATH + f'/TFR-TUNING/AR_FT_Hyperparameters/Length_{length}'
