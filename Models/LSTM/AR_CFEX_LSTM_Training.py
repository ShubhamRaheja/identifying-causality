...
Code Description: A python code to tune the hyperparameters of LSTM on the AR+CFEX dataset.
"""
import os
seed_value = 0
...
# Validation
FOLD_NO = 5
INITIAL_NEURAL_ACTIVITY = np.arange(0.01, 0.5, 0.01) #[0.21]
DISCRIMINATION_THRESHOLD = [0.499]
EPSILON = [0.171] # np.arange(0.1, 0.49, 0.1)
...
# Checkpoints path 
PATH = os.getcwd()
RESULT_PATH_DL = PATH + '/Models/LSTM/LSTM-logs/AR_CFEX_Checkpoints/'
...
PATH = os.getcwd()
RESULT_PATH = PATH + f'/Models/LSTM/LSTM-TUNING/AR_CFEX_Hyperparameters/Length_{length}'
RESULT_PATH_FINAL = PATH + f'/Models/LSTM/TESTING-RESULTS/On_Training_set/AR_CFEX_Results/Length_{length}'
