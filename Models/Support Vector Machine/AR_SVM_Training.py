...
Code Description: A python code to tune the hyperparameters of SVM on the AR dataset.
"""
import os
import numpy as np
import pickle
...
RESULT_PATH = PATH + f'/SVM-TUNING/AR_Hyperparameters/Length_{length}'
RESULT_PATH_FINAL = PATH + f'/TESTING-RESULTS/On_Training_set/AR_Results/Length_{length}'
RESULT_PATH_SVM = PATH + '/SVM-logs/AR_Checkpoints/'
